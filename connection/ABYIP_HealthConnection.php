...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($stmt->execute()) {
        // Generate PDF URL
        $pdf_url = "../connection/pdf_abyip_health.php?table=abyip_health&year=" . urlencode($calendar_year) . "&month=" . urlencode($period_of_implementation);
