...
class PDF extends FPDF {
    ...
    function Header() {
        ...
        $this->MultiCell(0, 5, 'For the youth to participate in the planning, implementation, monitoring and evaluation of child and youth-friendly programs, policies and activities on environmental protection, climate change adaptation and mitigation and DRRM, with the use of new technologies and indigenous, so as to promote sustainable natural ecosystems and smarter localities, biodiversity conservation, waste management and pollution.');
