...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // SQL Insert query
    $sql = "INSERT INTO abyip_education (
    ...
    if ($stmt->execute()) {
        // Generate PDF URL
        $pdf_url = "../connection/pdf_abyip_education.php?table=abyip_education&year=" . urlencode($calendar_year) . "&month=" . urlencode($period_of_implementation);
