...
class PDF extends FPDF {
    ...
    function Header() {
        ...
        $this->MultiCell(0, 5, 'For the youth to participate in an environment where Sports are given importance and recognize as one of the key components in increasing youth participation, development of skills and attitude of the youth towards sports. ');
...
if(isset($_GET['year'])) {
    ...
    $sql = "SELECT * FROM cbydp_pa_governance WHERE calendar_year = ?";
...
$pdf->Output('CBYDP_Governance_Plan.pdf', 'I');
?>
