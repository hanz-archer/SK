...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // SQL Insert query
    $sql = "INSERT INTO abyip_agriculture (
    ...
    if ($stmt->execute()) {
        // Generate PDF URL
        $pdf_url = "../connection/pdf_abyip_agriculture.php?table=abyip_agriculture&year=" . urlencode($calendar_year) . "&month=" . urlencode($period_of_implementation);
