...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // SQL Insert query
    $sql = "INSERT INTO abyip_environment (
    ...
    if ($stmt->execute()) {
        // Generate PDF URL
        $pdf_url = "../connection/pdf_abyip_environment.php?table=abyip_environment&year=" . urlencode($calendar_year) . "&month=" . urlencode($period_of_implementation);
