...
class PDF extends FPDF {
    ...
    function Header() {
        ...
        $this->MultiCell(0, 5, 'For the Sangguniang Kabataan Council to optimize their resources and for them to strengthen and enhance their leadership skills and knowledge.');
