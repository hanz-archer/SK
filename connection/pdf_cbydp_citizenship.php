...
class PDF extends FPDF {
    ...
    function Header() {
        ...
        $this->MultiCell(0, 5, 'For the youth to participate in community development and nation building through meaningful, active, sustainable, productive, and patriotic engagement in civil society, social mobilization, volunteerism and values formation so as to improve the plight of the youth.');
...
if(isset($_GET['year'])) {
    ...
    $sql = "SELECT * FROM cbydp_pa_citizenship WHERE calendar_year = ?";
...
$pdf->Output('CBYDP_Citizenship_Plan.pdf', 'I');
?>
