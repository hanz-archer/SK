...
<body>
    <header>
        <div class="logo">
            ...
            <span class="logo-text">SK Sumaguan - Post ABYIP General Administration Program</span>
        </div>
        <nav class="nav-links">
    ...
    <div class="form-container">
        <h1>ABYIP - General Administration Program</h1>
            ...
            $('#investment-plan-form').on('submit', function(e) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: '../connection/ABYIP_GAPConnection.php',
                            type: 'POST',
                            data: $(this).serialize(),
                            dataType: 'json',
