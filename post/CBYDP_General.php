...
<head>
    ...
    <title>Comprehensive Barangay Youth Development Plan - General Administration</title>
...
<body>
    <header>
        <div class="logo">
            ...
            <span class="logo-text">SK Sumaguan - Post CBYDP General Administration</span>
        </div>
        <nav class="nav-links">
    ...
    <div class="form-container">
        <h1>CBYDP - General Administration</h1>
    ...
    <script>
        $(document).ready(function() {
            $('#investment-plan-form').on('submit', function(e) {
                ...
                $.ajax({
                    url: '../connection/CBYDP_GeneralConnection.php',
                    type: 'POST',
                    data: $(this).serialize(),
                    dataType: 'json',
                    success: function(response) {
                        if (response.status === 'success') {
                            ...
                            const pdfUrl = '../connection/pdf_cbydp_general.php?' + 
