...
<body>
    <header>
        <div class="logo">
            ...
            <span class="logo-text">SK Sumaguan - Post ABYIP Social Inclusion and Equity</span>
        </div>
        <nav class="nav-links">
    ...
    <div class="form-container">
        <h1>ABYIP - Social Inclusion and Equity</h1>
            ...
            $('#investment-plan-form').on('submit', function(e) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: '../connection/ABYIP_SIEConnection.php',
                            type: 'POST',
                            data: $(this).serialize(),
                            dataType: 'json',
