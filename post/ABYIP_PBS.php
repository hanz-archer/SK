...
<body>
    <header>
        <div class="logo">
            ...
            <span class="logo-text">SK Sumaguan - Post ABYIP Peace Building and Security</span>
        </div>
        <nav class="nav-links">
    ...
    <div class="form-container">
        <h1>ABYIP - Peace Building and Security</h1>
            ...
            $('#investment-plan-form').on('submit', function(e) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: '../connection/ABYIP_PBSConnection.php',
                            type: 'POST',
                            data: $(this).serialize(),
                            dataType: 'json',
