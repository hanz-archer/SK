...
<head>
    ...
    <title>Comprehensive Barangay Youth Development Plan - Sports Development</title>
...
<body>
    <header>
        <div class="logo">
            ...
            <span class="logo-text">SK Sumaguan - Post CBYDP Sports Development</span>
        </div>
        <nav class="nav-links">
    ...
    <script>
        $(document).ready(function() {
            $('#investment-plan-form').on('submit', function(e) {
                ...
                $.ajax({
                    url: '../connection/CBYDP_SportsConnection.php',
                    type: 'POST',
                    data: $(this).serialize(),
                    dataType: 'json',
                    success: function(response) {
                        if (response.status === 'success') {
                            ...
                            const pdfUrl = '../connection/pdf_cbydp_sports.php?' + 
