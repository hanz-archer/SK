...
<head>
    ...
    <title>Comprehensive Barangay Youth Development Plan - Environment</title>
...
<body>
    <header>
        <div class="logo">
            ...
            <span class="logo-text">SK Sumaguan - Post CBYDP Environment</span>
        </div>
        <nav class="nav-links">
    ...
    <script>
        $(document).ready(function() {
            $('#investment-plan-form').on('submit', function(e) {
                ...
                $.ajax({
                    url: '../connection/CBYDP_EnvironmentConnection.php',
                    type: 'POST',
                    data: $(this).serialize(),
                    dataType: 'json',
