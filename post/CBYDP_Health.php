...
<head>
    ...
    <title>Comprehensive Barangay Youth Development Plan - Health</title>
...
<body>
    <header>
        <div class="logo">
            ...
            <span class="logo-text">SK Sumaguan - Post CBYDP Health</span>
        </div>
        <nav class="nav-links">
    ...
    <script>
        $(document).ready(function() {
            $('#investment-plan-form').on('submit', function(e) {
                ...
                $.ajax({
                    url: '../connection/CBYDP_HealthConnection.php',
                    type: 'POST',
                    data: $(this).serialize(),
                    dataType: 'json',
                    success: function(response) {
                        if (response.status === 'success') {
                            ...
                            // Construct PDF URL
                            const pdfUrl = '../connection/pdf_cbydp_health.php?' + 
