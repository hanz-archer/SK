...
<head>
    ...
    <title>Comprehensive Barangay Youth Development Plan - Citizenship</title>
...
<body>
    <header>
        <div class="logo">
            ...
            <span class="logo-text">SK Sumaguan - Post CBYDP Citizenship</span>
        </div>
        <nav class="nav-links">
